          ...
          >
            ...
            <div>
              ...
              <p
                ...
                style={{ fontSize: '25px', color: 'rgba(122,146,176,0.8)' }}
              >
            ...
            <p
              className="font-body"
              style={{ fontSize: '25px', color: '#7a92b0', lineHeight: 1.85 }}
            >
            ...
            <ul
              ...
              style={{ fontSize: '25px', color: '#7a92b0' }}
            >
              {[
            ...
            <p
              className="font-ui"
              style={{ fontSize: '13px', color: 'rgba(122,146,176,0.55)', letterSpacing: '0.04em' }}
            >
