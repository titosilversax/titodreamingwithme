        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-6 mb-6">
            <button
              ...
              onMouseEnter={(e) => (e.currentTarget.style.color = 'rgba(0,217,255,0.6)')}
              onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(122,146,176,0.45)')}
            >
              Terms of Service
            </button>
            <span style={{ color: 'rgba(122,146,176,0.2)', fontSize: '0.7rem' }}>·</span>
            <button
